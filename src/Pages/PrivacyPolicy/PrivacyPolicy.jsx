...
const PrivacyPolicy = () => {
  return (
    <div className="privacy-policy-container">
      ...
      <p>Effective Date: 9/16/2024</p>

      <section className="privacy-section">
        <h2>1. Introduction</h2>
        <p>
          Elevated Steel Solutions ("we," "our," or "us") is committed to
      ...
      <section className="privacy-section">
        ...
        <p>
          ...
          services, communicate with you, and improve our website. We do not
      ...
      <section className="privacy-section">
        ...
        <p>
          ...
          at:
          <a href="mailto:info@elevatedsteel.com">
            {" "}
            info@elevatedsteelsolution.online
          </a>
          .
        </p>
      </section>
